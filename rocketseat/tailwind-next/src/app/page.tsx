      ...
      <div className="mt-6 flex flex-col">
        <div className="flex items-center justify-between border-b border-zinc-200 pb-5">
          <div className="space-y-1">
            ...
            <span className="text-zinc-5000 text-sm">
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              className="border-zin-300 rounded-lg border px-4 py-2 text-sm font-semibold text-zinc-700 shadow-sm hover:bg-zinc-50"
            >
              Cancel
            </button>
            <button
